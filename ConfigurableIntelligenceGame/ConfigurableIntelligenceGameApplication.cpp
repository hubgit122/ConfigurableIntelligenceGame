...
// ConfigurableIntelligenceGameApplication.cpp : 定义应用程序的类行为。
//
...
// CConfigurableIntelligenceGameApplicationApp 构造
...
// 唯一的一个 CConfigurableIntelligenceGameApplicationApp 对象

CConfigurableIntelligenceGameApplicationApp theApp;


// CConfigurableIntelligenceGameApplicationApp 初始化
...
// CConfigurableIntelligenceGameApplicationApp 消息处理程序
...
// CConfigurableIntelligenceGameApplicationApp 自定义加载/保存方法
