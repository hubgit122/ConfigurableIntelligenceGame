...
// ConfigurableIntelligenceGame.cpp : 定义应用程序的类行为。
//
...
// CConfigurableIntelligenceGameApp 构造
...
// 唯一的一个 CConfigurableIntelligenceGameApp 对象

CConfigurableIntelligenceGameApp theApp;


// CConfigurableIntelligenceGameApp 初始化
